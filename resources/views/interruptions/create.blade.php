    ...
    <section class="advisory">
        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('int.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="mb-3">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="text" class="form-control @error('what') is-invalid @enderror" rows="1" name="what"></textarea>
                                    </div>
                                    @error('what')
                            ...
                            <div class="row ">
                                ...
                                <div class="col-5 mb-4">
                                    <div class="input-group date">
                                        <input type="text" class="form-control @error('dateTime') is-invalid @enderror" name="dateTime" id="datetimes"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="mb-3">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="text" class="form-control @error('where') is-invalid @enderror" rows="" name="where">
                                    </div>
                                    @error('where')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
